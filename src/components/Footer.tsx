...
import { GitHub, Twitter, Linkedin, Mail, Brain, Zap, Terminal, Gamepad2 } from 'lucide-react'

const socialLinks = [
  { href: 'https://github.com/masonvickery', label: 'GitHub', icon: GitHub },
  { href: 'https://twitter.com/masonvickery', label: 'Twitter', icon: Twitter },
  { href: 'https://linkedin.com/in/masonvickery', label: 'LinkedIn', icon: Linkedin },
        ...
        <div className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4 text-sm text-slate-500 dark:text-slate-500">
              ...
              <a
                href="https://github.com/masonvickery/hermes-portfolio"
                target="_blank"
                rel="noopener noreferrer"
