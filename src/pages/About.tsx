...
import { Linkedin, Mail, Twitter, GitHub, Brain } from 'lucide-react'
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="flex gap-4">
                {[
                  { icon: GitHub, href: 'https://github.com/masonvickery' },
                  { icon: Linkedin, href: 'https://linkedin.com/in/masonvickery' },
                  { icon: Twitter, href: 'https://twitter.com/masonvickery' },
